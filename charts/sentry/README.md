...
- Dedicated `ingress.assets` and `ingress.static` Ingresses were removed. Use `ingress.annotations` or create custom Ingress objects via `extraManifests` if you need per-path behavior.
