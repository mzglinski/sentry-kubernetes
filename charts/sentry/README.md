...
| global.kafkaClientRackAwareness.sentryKafkaConfigPyClientRackHotfix | bool | `true` | PoC: initContainer patches `kafka_config.py` so `client.rack` is allowlisted; disable after upstream Sentry adds it |
| google | object | `{}` |  |
